        ...
        <div class="ml-72 flex-1 overflow-auto">
            ...
            <div class="bg-white border-b border-gray-200 sticky top-0 z-10 shadow-sm">
                <div class="p-8 flex justify-between items-center">
                    <div>
                        <h2 class="text-3xl font-bold text-gray-900 mb-1">Tambah Meja Baru</h2>
                        <p class="text-gray-500">Tambahkan meja baru untuk restoran Anda</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-8">
                <div class="max-w-2xl">
                    ...
                    <div class="bg-white rounded-xl border border-gray-200 shadow-md overflow-hidden">
                        <form action="<?= base_url('admin/tables/store') ?>" method="POST" class="p-8 space-y-6">
                            <?= csrf_field() ?>
